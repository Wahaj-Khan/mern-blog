  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 md:mt-12 w-full px-4'>
      ...
      <form className='flex flex-col w-full md:w-1/3 mt-8 md:mt-12 gap-4'>
        <div className='mb-2 w-32 h-32 self-center shadow-md overflow-hidden rounded-full'>
          <img src={currentUser.profilePicture} alt="profile image" className='w-32 h-32 object-cover rounded-full border-4 border-blue-400 cursor-pointer' />
        </div>
